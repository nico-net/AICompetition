...
%       None. The function saves the generated images to disk.
    ...
    while idxFrame < numFrame
        ...
        overlapLabelledImages(data_tot, idxFrame, dirName, label);
        pause(8);
        close all
    end
end
...
function overlapLabelledImages(data, idxFrame, dir, label)
...
%       None. The function saves the composite image to disk.
    ...
    filename = convertCharsToStrings(label) + '_frame_' + num2str(idxFrame);
