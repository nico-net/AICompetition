function cleanWf = helperZigBeeSDR(spc, numPackets, timeDuration, sampleRate, txPower)
...
%       txPower       - Transmitting power (in dBm)
%
%   Output:
